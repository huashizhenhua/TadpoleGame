...
public class MainActivity extends SherlockFragmentActivity implements
		...
		AdapterCallback<Voice>, IWeiboHandler.Response, OnAlertSelectId,
		INotify {
	...
	private void performUpdateMusicProgressLoop() {
		MusicPlayer musicPlayer = VEApplication
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabUserVoice = actionBar.newTab()
				.setText(R.string.title_section_user_voice)
				.setTabListener(this);
		mTabHostVoice = actionBar.newTab()
				.setText(R.string.title_section_hot_voice).setTabListener(this);
		mTabMyCollection = actionBar.newTab()
				.setText(R.string.title_section_my_collection)
				.setTabListener(this);
		mTabSearch = actionBar.newTab().setText(R.string.title_section_search)
				.setTabListener(this);
		mTabAppRecommend = actionBar.newTab()
				.setText(R.string.title_section_app_recommend)
				.setTabListener(this);
		;
	...
	public void onCommand(View view, final Voice obj, int command, int position) {
		...
		case VoiceAdapter.CMD_SHARE:
			BaseDialog dialog = WeixinAlert.buildAlertDialog(view.getContext(),
					"发送【" + obj.title + "】", "", this, null);
			dialog.setTag(obj);
			dialog.show();
			break;
		default:
