...
public class SearchAPI extends WeiboAPI {
	...
	public String users(String q, int count) throws WeiboException {
		WeiboParameters params = new WeiboParameters();
		params.add("q", q);
		params.add("count", count);
		return requestSync(SERVER_URL_PRIX + "/suggestions/users.json", params,
				HTTPMETHOD_GET);
	}
	 ...
	 * @param listener
	 */
	public void schools(String q, int count, SCHOOL_TYPE type,
