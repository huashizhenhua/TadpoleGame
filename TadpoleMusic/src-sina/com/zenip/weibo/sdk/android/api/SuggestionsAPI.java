...
/**
 * 该类封装了推荐接口，详情请参考<a href=
 * "http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2#.E6.8E.A8.E8.8D.90"
 * >推荐接口</a>
 * 
...
public class SuggestionsAPI extends WeiboAPI {
    ...
    public void mayInterested(int count, int page, RequestListener listener) {
        ...
        requestAsync(SERVER_URL_PRIX + "/users/may_interested.json", params, HTTPMETHOD_GET,
                listener);
    }
    ...
    public void notInterested(long uid, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("uid", uid);
        requestAsync(SERVER_URL_PRIX + "/users/not_interested.json", params, HTTPMETHOD_POST,
                listener);
    }
}
