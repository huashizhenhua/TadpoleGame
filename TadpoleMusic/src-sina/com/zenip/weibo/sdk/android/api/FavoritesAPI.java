...
/**
 * 此类封装了收藏的接口，详情见<a href=
 * "http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2#.E6.94.B6.E8.97.8F"
 * >公共接口</a>
 * 
...
public class FavoritesAPI extends WeiboAPI {
    ...
    public void tagsDestroyBatch(long tid, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.add("tid", tid);
        requestAsync(SERVER_URL_PRIX + "/tags/destroy_batch.json", params, HTTPMETHOD_POST,
                listener);
    }
}
