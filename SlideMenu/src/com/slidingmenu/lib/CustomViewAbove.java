...
public class CustomViewAbove extends ViewGroup {
    ...
    public int getBehindSecondaryWidth() {
        if (mViewBehind == null) {
            ...
            return mViewBehind.getBehindSecondaryWidth();
        }
    }
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        // 向左
        if (dx > 0) {
            tmpWidth = getBehindWidth();
        }
        // 向右
        else {
            tmpWidth = getBehindSecondaryWidth();
        }
    ...
    protected float getPercentOpen() {
        int behindWidth = mScrollX > mContent.getLeft() ? getBehindWidth() : getBehindSecondaryWidth();
        return Math.abs(mScrollX - mContent.getLeft()) / behindWidth;
    }
