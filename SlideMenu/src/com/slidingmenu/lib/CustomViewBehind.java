...
public class CustomViewBehind extends ViewGroup {
    ...
    private int mWidthOffsetSecondary;
    ...
    public void setWidthOffset(int i, int secondI) {
        mWidthOffset = i;
        mWidthOffsetSecondary = secondI;
        requestLayout();
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        System.out.println("mWidthOffset = " + mWidthOffset);
        System.out.println("mWidthOffsetSecondary = " + mWidthOffsetSecondary);
        if (mSecondaryContent != null)
            mSecondaryContent.layout(0, 0, width - mWidthOffsetSecondary, height);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int sencondWidth = getChildMeasureSpec(widthMeasureSpec, 0, width - mWidthOffsetSecondary);

        mContent.measure(contentWidth, contentHeight);
        if (mSecondaryContent != null)
            mSecondaryContent.measure(sencondWidth, contentHeight);
    }
    ...
    public void scrollBehindTo(View content, int x, int y) {
        ...
        if (mMode == SlidingMenu.LEFT) {
            ...
            if (x <= content.getLeft()) {
                ...
                scrollTo((int) (getBehindSecondaryWidth() - getWidth() + (x - getBehindSecondaryWidth()) * mScrollScale), y);
            }
        }
