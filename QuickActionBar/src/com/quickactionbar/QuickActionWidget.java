 ...
 * notification bar). Clients may listen to user actions using a {@link OnQuickActionClickListener} .
 * 
...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    public static final int WIDTH_MODE_MEASURE_BY_CHILD = 1;
    public static final int WIDTH_MODE_MEASURE_UNSPECIFY = 1 << 1;
    ...
    private int mWidthMode = WIDTH_MODE_MEASURE_UNSPECIFY;
     ...
     * By setting a positive offset, the arrow will overlap the view given by {@link #show(View)}. The default value is 5dp.
     * 
     * @param offsetY
     ...
     *            True if you want the {@link QuickActionWidget} to
    ...
    /**
     * Add a new QuickAction to this {@link QuickActionWidget}. Adding a new {@link QuickAction} while the {@link QuickActionWidget} is currently
    ...
    protected void setWidgetSpecs(int popupY, int popupX, boolean isOnTop) {
        mPopupY = popupY;
        mIsOnTop = isOnTop;
        mPopupX = popupX;
    ...
    private void showArrow() {
        ...
        param.leftMargin = getWidth() - (arrow.getMeasuredWidth() / 2) - (mRect.width() / 2);
    }
