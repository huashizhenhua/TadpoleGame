...
import org.tadpole.adapter.DateAdapter;
...
public class DragGridView extends GridView {
    ...
    public static final int EVENT_DEL_DOWN = 4;
    public static final int EVENT_RELEASE = 5;
        ...
        if (moveNum > 0) {
            ...
            if (stopCount > 10) {
                ...
                if (x >= (moveNum + 1) * Configure.screenWidth - 20 * Configure.screenDensity && Configure.curentPage < Configure.countPages - 1) {
                    ...
                    DragGridView.this.onPage(EVENT_SLIDING_PAGE, ++Configure.curentPage);
                    moveNum++;
    ...
    private void onDrop(int x, int y) {
        ...
        if (Configure.isDelDark) {
            ...
            DelDone.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    DragGridView.this.onPage(EVENT_RELEASE, -300);
                }
            });
        ...
        DragGridView.this.onPage(4, -300);
